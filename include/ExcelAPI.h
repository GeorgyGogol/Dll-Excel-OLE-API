...
extern "C" {
	...
	namespace exl {
		...
		public:
			TExcelObjectRangedTemplate(TExcelObject* pParent,
				const Variant& data);
			TExcelObjectRangedTemplate
				(const TExcelObjectRangedTemplate<T>& src);
	...
	extern "C" {
		...
		namespace exl {
			...
			class __declspec(dllexport)
				TExcelCells : public TExcelObjectRangedTemplate<
				TExcelCells>, public IFormatManager<TExcelCells> {
			public:
			...
			public:
				...
				namespace exl {
					...
					class __declspec(dllexport)
						TExcelTableColumn :
						public TExcelObjectRangedTemplate
						<TExcelTableColumn>,
					public IFormatManager<TExcelTableColumn> {
					public:
						TExcelTableColumn(TExcelObject* pParent,
							const Variant& data);
						...
						TExcelTableColumn* SetHorizontalAlign
							(ExcelTextAlign align);
						TExcelTableColumn* SetVerticalAlign
							(ExcelTextAlign align);
				...
				namespace exl {
					...
					class __declspec(dllexport)
						TExcelTable : public TExcelObjectTemplate<
						TExcelTable> {
					public:
						TExcelTable(TExcelObject* pSheet,
							const String& tableName);
						TExcelTable(TExcelObject* pSheet,
							const Variant& vTable);

						TExcelTable(TExcelObject* pSheet,
							const Variant& vTable, const Variant& vTitle);
						TExcelTable(TExcelObject* pSheet,
							const Variant& vTable, TExcelCells* eTitile);
					...
					public:
						...
						TExcelCells* GetField(unsigned int col,
							unsigned int row);
				...
				namespace exl {
					...
					public:
						...
						void PrepareNewData(TExcelObject* sheet,
						...
						TExcelCells* InsertData(unsigned int col,
							unsigned int row,
							bool needInsertFieldNames = false);
						TExcelTable* CreateTable(unsigned int col,
							unsigned int row);
				...
				namespace exl {
					...
					public:
						...
						typedef std::vector<TExcelTablePivotField>
							tSettingsArray;
					...
					public:
						...
						void AddRow(const String& сolumnName,
							const String& caption = "");
						void AddColumn(const String& сolumnName,
							const String& caption = "");
						void AddData(const String& сolumnName,
							const String& caption = "",
							XlConsolidationFunction function
				...
				namespace exl {
					...
					private:
						...
						TExcelTable* initPivot(TExcelObject* aimSheet,
					...
					public:
						...
						TExcelTable* CreateTable(TExcelObject* aimSheet,
							unsigned int col, unsigned int row,
							TPivotSettings* PivotSettings);
				...
				namespace exl {
					...
					class __declspec(dllexport)
						TExcelNameItem : public TExcelObjectTemplate<
						TExcelNameItem> {
					private:

					public:
						TExcelNameItem(TExcelObject* pParent,
							const Variant& data);
					...
					class ITExcelNames {
					public:
						virtual TExcelNameItem* GetNameItem
							(const String& itemName) = 0;
						virtual TExcelNameItem* GetNameItem(unsigned int N) = 0;

						virtual TExcelNameItem* AddNamedItem
							(const String& itemName) = 0;
				...
				namespace exl {
					...
					class __declspec(dllexport)
						TExcelSheet : public TExcelObjectRangedTemplate<
						TExcelSheet>, public ITExcelNames {
					public:
					...
					public:
						TExcelCells* SelectCell(unsigned int col,
							unsigned int row);
				...
				namespace exl {
					...
					class __declspec(dllexport)
						TExcelWorkbook : public TExcelObjectTemplate<
						TExcelWorkbook>, public ITExcelNames {
					public:
						TExcelWorkbook(const TExcelWorkbook&);
						TExcelWorkbook(TExcelObject* pParent,
							const Variant& data);
						~TExcelWorkbook();
